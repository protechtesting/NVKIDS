...

{
	...
	@Test(priority=17,description="Navigate to View High Profile Restricted Cases screen function")
	...
	@Test(priority=18,description="Inquire with null values in CASE and PARTICIPANT fields present in the Select Filters")
	...
	@Test(priority=19,description="Inquire with values in CASE field present in the Select Filters. - Without Records")
   ...
   @Test(priority=20,description="Inquire with values in PARTICIPANT field present in the Select Filters. - Without Records")
	...
	@Test(priority=21,description="Inquire with values in USER field present in the Select Filters. - Without Records")
	public void InquirewithNoMatchingUser() throws Exception 
	{
		...
		@Test(priority=22,description="Inquire with values in CASE field present in the Select Filters. - With Records")
		...
		@Test(priority=23,description="Inquire with values in PARTICIPANT field present in the Select Filters. - With Records")
		...
		@Test(priority=24,description="Inquire with values in USER field present in the Select Filters. - With Records")
